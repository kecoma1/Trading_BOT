...
def thread_orders(stop_event, data, trading_data):
    ...
    while data["MACD"] is None or data["SIGNAL"] is None:
        pass
    ...
    while not stop_event.wait(0.0001):
        ...
        if data["MACD"][0] > data["SIGNAL"][0] and data["MACD"][1] < data["SIGNAL"][1] \
        ...
        elif data["MACD"][0] < data["SIGNAL"][0] and data["MACD"][1] > data["SIGNAL"][1] \
